...
\section{Generalization of ideas of CCP-Relax algorithm}

In practice,
the described heuristic algorithm demonstrates
good performance with high quality of the obtained solutions,
at least for practical cutting tasks
for CNC machines,
this is described in more detail in section \ref{sec:calc}.

\subsection{Using other methods of discrete optimization}

\subsection{Approach to ICP}

Intermittent Cutting Problem
is the most complex and general
of all varieties of cutting problems.

Using complex cutting segments as seen at Fig.~\ref{fig:6x5}...
